...
! symmetry-adapted subshell states. This includes a collection of 
! routines which are concerned with the calculation of recoupling matrices
! in jj--coupling (see in G. Gaigalas et al., 1997 J. Phys. B: At. Mol. 
...
!-----------------------------------------------------------------------
   ...
   private :: recoupling_C_1
                 ! Returns the value of the coefficient C_1 from the paper 
                 ! of G. Gaigalas et al., 1997 J. Phys. B: At. Mol. Opt. Phys,
                 ! Vol 30 3747. The expression of C_1 is given in Eq. (15).
   private :: recoupling_C_2
                 ! Returns the value of the coefficient C_2 from the paper
                 ! of G. Gaigalas et al., 1997 J. Phys. B: At. Mol. Opt. Phys,
                 ! Vol 30 3747. The expression of C_2 is given in Eq. (16).
   private :: recoupling_C_3
                 ! Returns the value of the coefficient C_3 from the paper
                 ! of G. Gaigalas et al., 1997 J. Phys. B: At. Mol. Opt. Phys,
                 ! Vol 30 3747. The expression of C_3 is given in Eq. (17).
   private :: recoupling_C_4
                 ! Returns the value of the coefficient C_4 from the paper
                 ! of G. Gaigalas et al., 1997 J. Phys. B: At. Mol. Opt. Phys,
                 ! Vol 30 3756. The expression of C_4 is given in Eq. (21).
   private :: recoupling_C_5
                 ! Returns the value of the coefficient C_5 from the paper
                 ! of G. Gaigalas et al., 1997 J. Phys. B: At. Mol. Opt. Phys,
                 ! Vol 30 3747. The expression of C_5 is given in Eq. (23).
   public  :: recoupling_matrix_check
                 ! Checks the angular momentum selection rules for the
                 ! recoupling coefficients.
   public  :: recoupling_matrix_check_nonscal
                 ! Checks the angular momentum selection rules for the
                 ! recoupling coefficients of non scalar operator.
   public  :: recoupling_matrix_1p_shells
                 ! Calculates the recoupling matrix for a non scalar operator
                 ! in the case of one interacting shells.
   public  :: recoupling_matrix_2_shells
                 ! Calculates the recoupling matrix for a scalar operator
                 ! in the case of two interacting shells.
   ...
   private :: recoupling_matrix_3_ordered
                 ! Auxiliarity routine for the procedure 
                 ! recoupling_matrix_3_shells
   public  :: recoupling_matrix_4_shells
                 ! Calculates the recoupling matrix for a scalar operator
                 ! in the case of four interacting shells.
contains
   !
